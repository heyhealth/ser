...
MODEL = Wav2Vec2Model.from_pretrained(ARGS.MODEL_NAME_Wav2Vec2)
...
def extract_feature_by_Wav2Vec2(wav_path, resampled=False):
    """
    extract the features from wav using pretrained model Wav2Vect2
    :param wav_path:
    :return:
    """
...
def do_test():
    ...
    feat = extract_feature_by_Wav2Vec2(wav_path, resampled=False)
    print(feat.shape)
